...
Constant gap is part of the story of topologically ordered phases
\cite{Kitaev2003,Brown2016}.
%\cite{Wen1991} % 

\subsection{An example: the four qubit gauge code}
...
\section{Perron-Frobenius representations}
...
model &\ $n$\ &\ $r$\ &\ $t_X$\ & $|A|$ & $|\mathrm{orbits}|$ & Aut(code) \\
\hline
%    1D xy & 4 &  2& 0 & 2 & 3 & 8 \\
%       & 5 &  4& 0 & 10 & 4 & 10 \\
%       & 6 &  4& 0 & 72 & 3 & 12 \\
...
The mystery here is the graph automorphism group is
bigger, sometimes much bigger, than the automorphism group of
the underlying code.
So where is the extra symmetry coming from?

A crucial hint is provided by the fact that these graph
symmetries respect the symplectic structure in the following
sense...

All this suggests an examination of the commutation structure
of the code.
...
is defined as the minimum number of gauge operators needed
to form $s_X.$
...
Simple Lie algebras are classified into four infinite series
...
Here we show the simple Lie algebras for each of the models:
\begin{center}
